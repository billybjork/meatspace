...
`);
  ...
  var SpritePlayer = class {
    constructor(clipId, viewerElement, scrubElement, playPauseBtn, frameDisplayElement, meta, updateSplitUICallback) {
      this.clipId = clipId;
    ...
    _setupUI() {
      ...
      if (!this.meta || !this.meta.isValid) {
        ...
        if (this.scrubElement)
          this.scrubElement.disabled = true;
    ...
    _attachEventListeners() {
      ...
      if (this.scrubElement) {
        ...
        this.scrubElement.addEventListener("touchstart", this._handleScrubStart, { passive: true });
    ...
    play(source = "unknown") {
      ...
      if (this.isPlaying || !this.meta || !this.meta.isValid || this.meta.clip_fps <= 0) {
        console.log(`[Player ${this.clipId}] play() called from '${source}' but ignored (isPlaying=${this.isPlaying}, metaValid=${(_a2 = this.meta) == null ? void 0 : _a2.isValid}, fps=${(_b = this.meta) == null ? void 0 : _b.clip_fps})`);
        return;
      }
      this.isPlaying = true;
      if (this.playPauseBtn)
        this.playPauseBtn.textContent = "\u23F8\uFE0F";
      const intervalTime = 1e3 / this.meta.clip_fps;
      ...
      this.playbackInterval = setInterval(() => {
        var _a3, _b2;
        try {
          if (!this.isPlaying || !((_a3 = this.meta) == null ? void 0 : _a3.isValid)) {
            console.log(`[Player ${this.clipId}] Interval stopping (Internal Check: isPlaying=${this.isPlaying}, metaValid=${(_b2 = this.meta) == null ? void 0 : _b2.isValid})`);
            this.pause("intervalCheck");
            return;
          }
    ...
    */
    cleanup() {
      ...
      if (this.scrubElement) {
        if (this._handleScrubInput)
          this.scrubElement.removeEventListener("input", this._handleScrubInput);
        if (this._handleScrubStart)
          this.scrubElement.removeEventListener("mousedown", this._handleScrubStart);
        if (this._handleScrubStart)
          this.scrubElement.removeEventListener("touchstart", this._handleScrubStart);
        if (this._handleScrubEnd)
          this.scrubElement.removeEventListener("mouseup", this._handleScrubEnd);
        if (this._handleScrubEnd)
          this.scrubElement.removeEventListener("touchend", this._handleScrubEnd);
      ...
      this.meta = null;
      this.updateSplitUICallback = null;
